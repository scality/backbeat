...
class BackbeatConsumer extends EventEmitter {
    ...
    constructor(config) {
        ...
        const configJoi = {
            ...
            queueProcessor: joi.func().optional(),
    ...
    */
    subscribe() {
        ...
        console.log('this._concurrency!!!', this._concurrency);
        this._processingQueue = async.queue(
            this.processEntry.bind(this), this._concurrency);
        // this._processingQueue = async.queue((entry, done) => {
        //     return setTimeout(() => {
        //         return this._queueProcessor(entry, done);
        //     }, 10000);
        // }, this._concurrency);
        ...
        return this._consumer.consume(nNewConsumeRequests, (err, entries) => {
            ...
            if (!err) {
                entries.forEach(entry => {
                    ...
                    if (this.delayConsumption(entry)) {
                        return undefined;
                    }
    ...
    onEntryCommittable(entry) {
        ...
        console.log('committableOffset!!!', committableOffset);
