...
const { applyConfigOverrides } = require('./config/configOverrides');
...
class Config extends EventEmitter {
     ...
     */
    _parseConfig(config) {
        const patchedConfig = applyConfigOverrides(config);
        const parsedConfig = joi.attempt(patchedConfig, backbeatConfigJoi);
