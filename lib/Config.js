...
class Config extends EventEmitter {
    ...
    // FIXME: those azure and PFS functions have been copied from
    // Cloudserver, they are only there to avoid a crash of backbeat
    // containers when azure locations are configured in Orbit, but
    // replication to azure is not yet supported. (ZENKO-2429).
