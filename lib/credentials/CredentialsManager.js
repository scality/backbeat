...
class CredentialsManager extends EventEmitter {
     ...
     * @param {Number} maxInactiveDuration - how long past expiry credentials
     * are kept, in ms
     * @return {Number} how many credentials are left cached
     */
    removeInactiveCredentials(maxInactiveDuration) {
        ...
        return Object.keys(this._accountCredsCache).length;
    }
}
