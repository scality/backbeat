...
const logJoi =
          joi.object({
              logLevel: joi.alternatives().try(...LOG_LEVELS),
              dumpLevel: joi.alternatives().try(...LOG_LEVELS),
          }).default({
              logLevel: 'info',
              dumpLevel: 'error',
          });
...
const logJoiOptional =
          joi.object({
              logLevel: joi.alternatives().try(...LOG_LEVELS).required(),
              dumpLevel: joi.alternatives().try(...LOG_LEVELS).required(),
          }).optional();
