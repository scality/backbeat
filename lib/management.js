...
// FIX ME BY UPDATING GET CREDENTIALS UTILS IN ARSENAL
// TO USE MONGO AND THEN UPDATE HERE!!!
const MetadataFileClient = arsenal.storage.metadata.MetadataFileClient;
const mdClient = new MetadataFileClient({
    host: config.queuePopulator.mongo.host,
    port: config.queuePopulator.mongo.port,
});
