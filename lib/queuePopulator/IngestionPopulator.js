...
class IngestionPopulator {
    ...
    applyUpdates(cb) {
        ...
        console.log('applyUpdates!!!! => buckets', buckets);
    ...
    _getSourceInformation(ingestionInfo) {
        // TODO: ingestionInfo coming from the operator vs ingestionInfo coming from pensieve push
        ...
        const urlObject = url.parse(`${protocol}${endpoint}`);
    ...
    _processLogEntries(params, done) {
        ...
        console.log('this.logReaders!!!', this.logReaders.map(l => l.bucketdConfig));
