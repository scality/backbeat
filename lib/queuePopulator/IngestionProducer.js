...
// take another argument, prefix bucket name with site name
class IngestionProducer extends QueuePopulator {
    ...
    getBucketMd(bucketList, done) {
        ...
        return async.eachLimit(bucketList, 10, (bucket, cb) => {
            ...
            return this.ringReader.getBucket(bucketName, this.requestLogger, (err, res) => {
                console.log('WE GOT A BUCKET');
                console.log(this.createEntry.createPutBucketEntry(res));
                this.producer.send([this.createEntry.createPutBucketEntry(res)], () => {});
                return cb(err);
            });
        }, err => {
    ...
    getBucketObjectsMetadata(bucketObjectList, done) {
        ...
        return async.mapLimit(bucketObjectList, 1, (bucket, cb) => {
            ...
            return async.mapLimit(bucket.objects, 10, (object, cb) => {
                ...
                return this.getObjectMetadata(bucketName, objectKey,
                (err, res) => {
