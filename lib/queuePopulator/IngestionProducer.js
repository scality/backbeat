...
class IngestionProducer {
    ...
    _subscribeToRaftSessionDispatcher() {
        ...
        this.raftIdDispatcher.subscribe((err, items) => {
            ...
            console.log('THIS.LOGREADERSUPDATE');
            console.log(this.logReadersUpdate);
            return undefined;
        });
    ...
    getRaftSessionBuckets(done) {
        ...
        const ringReader = new MetadataWrapper('scality', ringParams, bucketclient, this.log);
        const requestLogger = this.log.newRequestLogger();
        ringReader.listObject('users..bucket', {}, requestLogger, (err, res) => {
