...
class QueuePopulator {
     ...
     * @param {string} ingestionConfig - configuration for ngestion
     */
    ...
    _subscribeToRaftSessionDispatcher(zkEndpoint, bucketd, ingestionPath) {
        ...
        this.raftIdDispatcher.subscribe((err, items) => {
            ...
            newRaftReaders.forEach(reader => this.logReadersUpdate.push(reader));
            console.log(typeof this.logReadersUpdate);
            console.log('LENGTH of logreadersupdate', this.logReadersUpdate);
            return undefined;
        });
        console.log('length of logreadersupdate', this.logReadersUpdate.length);
    ...
    _setupUpdatedReaders(done) {
        ...
        this.logReadersUpdate = [];
        console.log('LENGTH OF NEWREADERS', newReaders.length);
        console.log('length of logReaders', this.logReaders.length);
