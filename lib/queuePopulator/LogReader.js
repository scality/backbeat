...
class LogReader {
    ...
    _processPublishEntries(batchState, done) {
        ...
        // Hopefully there is a better way to find out if dmd, file, or MongoDB
        if (this.logConsumer.mongoUrl) {
            this.log.info('this is the logRes.info',
                { logResInfo: logRes.info });
