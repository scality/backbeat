...
export interface AclObj {
   ...
   * @public
   */
  Canned?: string | undefined;

  /**
   * List of users with FULL_CONTROL permission
   * @public
   */
  FULL_CONTROL?: (string)[] | undefined;
...
export interface LCRuleObj {
   ...
   * @public
   */
  Status?: LifecycleRuleStatus | undefined;
   ...
   * @public
   */
  Expiration?: ExpirationConfiguration | undefined;
}

/**
 * @public
 */
export interface LifecycleConfigurationObj {
  /**
   * List of lifecycle rules
   * @public
   */
  Rules?: (LCRuleObj)[] | undefined;
}
...
export interface GetBucketMetadataOutput {
   ...
   * @public
   */
  serverSideEncryption?: Record<string, string> | undefined;

  /**
   * Versioning configuration for the bucket
   * @public
   */
  versioningConfiguration?: Record<string, string> | undefined;
   ...
   * @public
   */
  replicationConfiguration?: Record<string, string> | undefined;

  /**
   * Lifecycle configuration for the bucket
   * @public
   */
  lifecycleConfiguration?: LifecycleConfigurationObj | undefined;
...
export interface PutDataOutput {
  Location?: __DocumentType | undefined;
}
