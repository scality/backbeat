...
class BackbeatAPI {
    ...
    isConnected() {
        ...
        console.log(this._zkClient.getState().name)
        return this._zkClient.getState().name === 'SYNC_CONNECTED'
            && this._checkProducersReady();
    }

    _checkProducersReady() {
        console.log(this._crrProducer.isReady())
        console.log(this._metricProducer.isReady())
        console.log(this._crrStatusProducer.isReady())
