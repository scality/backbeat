...
class BackbeatAPI {
    ...
    constructor(config, logger, optional) {
        ...
        this._metrics = new Metrics(metricsConfig, logger);
        Object.assign(this, {
            _queryStats: this._metrics._queryStats,
            _getData: this._metrics._getData,
            _hasGlobalKey: this._metrics._hasGlobalKey,
            _getMaxUptime: this._metrics._getMaxUptime,
            getBacklog: this._metrics.getBacklog,
            getCompletions: this._metrics.getCompletions,
            _sendCompletionsResponseReplication:
                this._metrics._sendCompletionsResponseReplication,
            _sendCompletionsResponseIngestion:
                this._metrics._sendCompletionsResponseIngestion,
            getObjectThroughput: this._metrics.getObjectThroughput,
            getObjectProgress: this._metrics.getObjectProgress,
            getThroughput: this._metrics.getThroughput,
            _sendThroughputResponseReplication:
                this._metrics._sendThroughputResponseReplication,
            _sendThroughputResponseIngestion:
                this._metrics._sendThroughputResponseIngestion,
            getAllMetrics: this._metrics.getAllMetrics,
            getPending: this._metrics.getPending,
            _sendPendingResponseReplication:
                this._metrics._sendPendingResponseReplication,
            _sendPendingResponseIngestion:
                this._metrics._sendPendingResponseIngestion,
        });
    }
     ...
     * @returns {undefined}
     */
    async monitoringHandler(details, cb) {
        const promMetrics = await ZenkoMetrics.asPrometheus();
