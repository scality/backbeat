...
const { lifecycleListing: { NON_CURRENT_TYPE, CURRENT_TYPE, ORPHAN_TYPE } } = require('./constants');
...
class BackbeatMetadataProxy extends BackbeatTask {
    ...
    // listLifecycleCurrents(params, log, cb) {
    //     this.backbeatSource.listLifecycleCurrents(params, (err, data) => {
    //         if (err) {
    //             // TODO: add logs;
    //             cb(err, null);
    //             return;
    ...
    // listLifecycleNonCurrents(params, log, cb) {
    //     this.backbeatSource.listLifecycleNonCurrents(params, (err, data) => {
    //         if (err) {
    //             // TODO: add logs;
    //             cb(err, null);
    //             return;
    ...
    // listLifecycleOrphans(params, log, cb) {
    //     this.backbeatSource.listLifecycleOrphans(params, (err, data) => {
    //         if (err) {
    //             // TODO: add logs;
    //             cb(err, null);
    //             return;
