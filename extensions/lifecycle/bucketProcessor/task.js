...
const {
    zookeeper, kafka, extensions, s3, transport, log, healthcheckServer,
} = config;
...
const bucketProcessor = new LifecycleBucketProcessor(zookeeper, kafka, extensions, s3, transport);
