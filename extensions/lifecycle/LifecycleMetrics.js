...
const replicationMetricNames =
      require('../replication/constants').promMetricNames;
...
class LifecycleMetrics {
    ...
    _buildKafkaConsumerLagQuery() {
        const consumerLagGauge = PromAPIClient.buildMetricSelector(
            queueMetricNames.kafkaConsumerGroupLag, {
    ...
    _getBacklogMetricsItem(partition, consumerGroup,
        ...
        return async.mapValues({
            count: replicationMetricNames.replicationQueuedTotal,
            bytes: replicationMetricNames.replicationQueuedBytes,
