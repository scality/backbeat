...
describe('lifecycle task helper methods', () => {
    ...
    describe('_retryEntry', () => {
        ...
        it('should not retry if error is not retriable', done => {
            const lct = new LifecycleTask(lp);
            const action = sinon.stub();
            action.callsArgWith(0, { code: 'NotRetriable', message: 'test' });
        ...
        it('should retry retryable errors up to 5 times', done => {
            ...
            const action = sinon.stub();
            action.callsArgWith(0, { code: 'NotRetriable', message: 'test', retryable: true });
