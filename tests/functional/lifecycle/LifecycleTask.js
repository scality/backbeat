...
describe('lifecycle task functional tests', function dF() {
    ...
    describe('object-locked bucket', () => {
        ...
        [
            {
                message: 'should not delete any locked objects (GOVERNANCE)',
                bucketLCRules: [
                    new LifecycleRule().addID('task-1').addExpiration('Date', PAST)
                        .build(),
                ],
            ...
            {
                message: 'should not delete any locked objects (COMPLIANCE)',
                bucketLCRules: [
                    new LifecycleRule().addID('task-1').addExpiration('Date', PAST)
                        .build(),
                ],
            ...
            {
                message: 'should not delete any objects with legal-hold',
                bucketLCRules: [
                    new LifecycleRule().addID('task-1').addExpiration('Date', PAST)
                        .build(),
                ],
