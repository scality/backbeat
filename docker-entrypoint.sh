...
if [[ "$EXTENSTIONS_REPLICATION_REPLICATION_STATUS_PROCESSOR_RETRY_TIMEOUT" ]]; then
    JQ_FILTERS_CONFIG="$JQ_FILTERS_CONFIG | .extensions.replication.replicationStatusProcessor.retryTimeoutS=\"$EXTENSTIONS_REPLICATION_REPLICATION_STATUS_PROCESSOR_RETRY_TIMEOUTS\""
fi

if [[ "$EXTENSTIONS_REPLICATION_QUEUE_PROCESSOR_RETRY_TIMEOUT" ]]; then
    JQ_FILTERS_CONFIG="$JQ_FILTERS_CONFIG | .extensions.replication.queueProcessor.retryTimeoutS=\"$EXTENSTIONS_REPLICATION_QUEUE_PROCESSOR_RETRY_TIMEOUTS\""
fi
